...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function cs(){return new qr({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:us(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ls(){return new qr({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:us(),fragmentShader:`
